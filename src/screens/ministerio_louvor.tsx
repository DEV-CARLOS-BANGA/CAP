...
export default function MINISTERIO_LOUVOR({ navigation }: any) {
    return (
        < >
            <Header navigation={navigation} />
            <ScrollView
                showsVerticalScrollIndicator={false}
                style={style.ministerio_louvor_container}
            >
                <Text style={style.title}>MINISTÉRIO DE LOUVOR</Text>
